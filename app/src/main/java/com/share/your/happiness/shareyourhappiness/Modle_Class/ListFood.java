...
public class ListFood {
    ...
    public ListFood(String area, String date, String distirct, String division, String name, String phone, String foodPicture, String post, String foodId, String upazila, String userId, String frizzing, String description, String firstName, String profilePicture, String available, String house, String time, String totalReceive, String totalDelivery) {
        this.area = area;
        this.date = date;
